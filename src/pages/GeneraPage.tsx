...
export default function GeneraPage() {
  ...
  const handleGenera = async (postId: string, pdfLink: string | null, noteCorrezione: string | null) => {
    ...
    try {
      const res = await fetch(webhookUrl, {
        ...
        body: JSON.stringify({ post_id: postId, pdf_link: pdfLink, note: noteCorrezione }),
      });
              ...
              <Card key={post.id} className="overflow-hidden">
                <CardContent className="p-4 flex items-center gap-4">
                  ...
                  <Button
                    ...
                    onClick={() => handleGenera(post.id, post.pdf_link, post.note_correzione)}
                  >
